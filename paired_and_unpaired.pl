...
my $total_reads = $paired_reads_count * 2 + $unpaired_reads_count;
my $ratio = $unpaired_reads_count / $total_reads;
print "\nTotal reads: $total_reads\n";
print "Unpaired reads: $unpaired_reads_count\n";
print "Ratio: $ratio\n\n";